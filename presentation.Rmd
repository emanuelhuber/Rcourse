...
![not tidy data](imgPres/data_tidying_table_messy.png){ width=50% }
...
- spatial interpolation
   - [gstat](http://rspatial.org/analysis/rst/4-interpolation.html)
   - [gstat](https://rpubs.com/nabilabd/118172)
   - [ipdw](https://cran.r-project.org/web/packages/ipdw/vignettes/ipdw2.html)
   - [automap package](http://www.numbertheory.nl/2013/02/17/automatic-spatial-interpolation-with-r-the-automap-package/)
