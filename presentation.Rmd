...
* Talk 1:
    1. Overview of R 
    2. R show case: potential use for AUG-group    
...
## R GIS - making and using bathymetric maps in R with `marmap` pakage
...
## OpenFOAM - Stochastic simulation 
...
## Interactive R teaching modules
